...
hist(rain.df$daily, col = "red", xlab = "Daily Rain", main = "Daily Rain in Canada")

```

**The histogram is unclear because there are a lot of zeros in the dataset**
...
rain.df[rain.df < 0] <- 0
rain.df$daily = apply(rain.df[,4:27], 1, sum)
hist(rain.df$daily, col = "pink", xlab = "Daily Rain", main = "Daily Rain in Canada")
```
